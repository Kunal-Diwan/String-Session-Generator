...
INPUT_PHONE_NUMBER = get_config("INPUT_PHONE_NUMBER", (
    "Enter the <b>Phone Number</b> below for which you want to start generating string ."
))
RECVD_PHONE_NUMBER_DBP = get_config("RECVD_PHONE_NUMBER_DBP", (
    "Checking received phone number 📲\n\n"
    "➡️ The Process can take long time .\n"
    "➡️ Please be Patient .\n\n"
    "<b><u>Never Submit Again</u></b> \n"
    "<b><u>It'll run the system</u></b>"
))
ALREADY_REGISTERED_PHONE = get_config("ALREADY_REGISTERED_PHONE", (
    ...
    "seperated by space in this format - <code>1 2 3 4</code>. \n\n"
...
NOT_REGISTERED_PHONE = get_config("NOT_REGISTERED_PHONE", (
    ...
    "Please register your number first then try again ."
))
...
ACC_PROK_WITH_TFA = get_config("ACC_PROK_WITH_TFA", (
    ...
    "<b>This message will only be used for generating your "
    "string session, and will never be used for any other purposes "
    "than for which it is asked.</b>\n\n"
))
